                                                ...
                                                <div class="register-form">
                                                    <form method="post" action="../backend/register.php" enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input required type="number" class="form-control"  name="student_id" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                               <div class="form-group">
                                                                   ...
                                                                   <select required name="department" class="" id="exampleFormControlSelect1">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <div class="form-group file-input">
                                                                        ...
                                                                        <label for="photo" class="custom-file" ><i class="fa fa-upload"></i>Upload Your Photo</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="register_deptno">Phone(Eg. 01780976220)</label>
                                                                    <input required type="tel" pattern="[0-9]{11}" class="form-control"  name="phone" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-12 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea required name="address" class="form-control" id="exampleFormControlTextarea1" rows="5" cols="50"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="gender form-group">
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input required type="radio" id="register_gender_male" name="gender" value="male" class="custom-control-input" />
                                                                <label class="custom-control-label" for="register_gender_male">Male</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input required type="radio" id="register_gender_female" name="gender" value="female" class="custom-control-input">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox float-lg-right">
                                                                <input required checked name="termsAndCondition" type="checkbox" class="custom-control-input" id="customCheck1">
